...
def file2anndata(indir, scale):
    ...
    df_zscores = pd.read_csv(indir+'/zscores.tsv.gz',
...
def atac_chromVar(adata, species, genome, feature, scale = False, n_jobs=1, env = 'stream2_chromVar', outdir='./stream2_atac'):      
